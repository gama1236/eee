...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
         maxZoom: 25, minZoom: 3, projection: new ol.proj.Projection({
            code: 'EPSG:4326',
            extent: [1053867.563517, 860190.166736, 1068491.891521, 879441.450271],
            units: 'degrees'})
    })
});
...
map.getView().fit([1031194.544535, 854921.327327, 1091938.324714, 889649.466446], map.getSize());
