...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [1048671.378372, 855936.084347, 1068630.463666, 879441.455873], maxZoom: 25, minZoom: 5, projection: new ol.proj.Projection({
            code: 'EPSG:4326',
            extent: [1048671.378372, 855936.084347, 1068630.463666, 879441.455873],
            units: 'degrees'})
    })
});
...
map.getView().fit([1048671.378372, 855936.084347, 1068630.463666, 879441.455873], map.getSize());
